...
- [ ] T008 [P] Cross-platform path handling tests in tests/integration/test_paths.py *(CLI tools only)*
- [ ] T009 [P] Shell wrapper tests (cmd/bash/WSL) in tests/integration/test_shells.py *(CLI tools only)*
