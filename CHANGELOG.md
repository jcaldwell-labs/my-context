...
- Test helper correctly adds `.exe` extension for Windows binary path

## [3.2.3] - 2026-01-13

### Fixed

- Test helper filters duplicate `MY_CONTEXT_HOME` env vars (Windows compatibility)

## [3.2.2] - 2026-01-13

### Fixed

- Signal commands now respect `MY_CONTEXT_HOME` environment variable for test isolation
- Fixed `TestSignalWaitSuccess` failing on Windows CI due to hardcoded signal directory path

## [3.2.1] - 2026-01-13

### Fixed

- CI workflow: Added X11 development libraries (`libx11-dev`) for clipboard package compilation on Linux
